...
const SCROLL_ORIGINS_NFT = process.env.NEXT_PUBLIC_SCROLL_ORIGINS_NFT
const SCROLL_ORIGINS_NFT_V2 = process.env.NEXT_PUBLIC_SCROLL_ORIGINS_NFT_V2
...
const ETHEREUM_YEAR_BASE_URL = `${process.env.NEXT_PUBLIC_CANVAS_BACKEND_URI}/badge`
