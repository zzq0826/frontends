...
import StepCompletedSvg from "@/assets/svgs/nft/step-completed-icon.svg"
import StepDefaultSvg from "@/assets/svgs/nft/step-default-icon.svg"
...
const NFTStepper = () => {
  ...
  useEffect(() => {
    if (activeStep === 1) {
      router.push("/developer-nft/mint")
    }
  }, [activeStep])
